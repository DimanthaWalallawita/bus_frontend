  ...
  return (
    <div className="min-h-screen w-full bg-[#F2F4F3] flex items-center justify-center bg-cover bg-center p-4 sm:p-6 md:p-10 font-sans" style={{ backgroundImage: `url(${banner})` }}>
      <div className="relative w-full max-w-4xl flex flex-col md:flex-row bg-white rounded-[28px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.25)] overflow-hidden">
        ...
        <div className="md:hidden absolute top-[42%] -left-4 w-8 h-8 rounded-full bg-[#F2F4F3] z-20" />
        <div className="md:hidden absolute top-[42%] -right-4 w-8 h-8 rounded-full bg-[#F2F4F3] z-20" />
              ...
              {[
                ...
                <div key={stop.city} className="flex items-start gap-3">
                  <div className="flex flex-col items-center">
                    <span
                      className={`w-3 h-3 rounded-full border-2 border-white ${i === 0 ? "bg-white" : "bg-transparent"
                        }`}
                    />
                    {i !== arr.length - 1 && (
        ...
        {/* RIGHT — form side */}
        <div className="w-full md:w-[62%] p-8 sm:p-10">
          <h2 className="text-2xl font-bold text-black">
            Create your account
          </h2>
          <p className="mt-1.5 text-sm text-gray-500">
            Fill in your details to start booking bus tickets.
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-7 space-y-4">
            ...
            <label className="flex items-start gap-2.5 pt-1 cursor-pointer select-none">
              <input
                ...
                className="mt-0.5 w-4 h-4 rounded border-gray-300 text-[#03B188] focus:ring-[#03B188] accent-[#03B188]"
              />
              <span className="text-xs text-gray-500 leading-relaxed">
                I agree to the{" "}
                <a href="#" className="text-[#03B188] font-medium hover:underline">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="#" className="text-[#03B188] font-medium hover:underline">
